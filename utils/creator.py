...
Creator is used for creating training model with checkpoint and meta files.
"""
...
class CognitionModelCreator(object):
    """Seq2Seq model creator to create models for training."""

    def __init__(self, training, tokenized, batch_input, scope=None):
        """
        Creates an instance for creating/training model.

        Arguments:
            self: An instance of the class.
            training: Boolean value to indicate if the model is training.
            tokenized: Object containing all details for the model.
            scope: Scope of the model.
        """
        self.training = training
        self.batch_input = batch_input
        self.vocab_table = tokenized.vocab_table
        self.vocab_size = tokenized.vocab_size
        self.reverse_vocab_table = tokenized.reverse_vocab_table

        hparams = tokenized.hparams
        self.hparams = hparams
        self.num_layers = hparams.num_layers
        self.time_major = hparams.time_major

        # Initializer
        initializer = assistant.get_initializer(
            hparams.init_op, hparams.random_seed, hparams.init_weight)
        tf.get_variable_scope().set_initializer(initializer)

        # Embeddings
        self.embedding = (assistant.create_embbeding(
            vocab_size=self.vocab_size,
            embed_size=hparams.num_units,
            scope=scope))
        # This batch size may change among the other batch instance due to the
        # bucketing and/or reach the end of the training set.
        # Here we would be treating it as size_of_the_batch.
        ...
        if training:
            ...
            clipped_gradients, gradient_norm_summary = assistant.gradient_clip(
    ...
    def train_step(self, sess, learning_rate):
        ...
        Arguments:
            ...
            learning_rate: Learning_rate of the model.
        """
    ...
    def build_graph(self, hparams, scope=None):
        """
        Creates a Seq2Seq model with dynamic RNN decoder API.

        Arguments:
            self: An instance of the class.
            hparams: Hyperparameters to be used.
            scope: Scope of the model.
        """
        dtype = tf.float32
    ...
    def _build_encoder_cell(self, hparams):
        ...
        Arguments:
            ...
            hparams: Hyperparameters to be used.
        """
        return assistant.create_rnn_cell(
    ...
    def _build_decoder(self, encoder_outputs, encoder_state, hparams):
        ...
        Arguments:
            ...
            encoder_state: Current state of the encoder.
            hparams: Hyperparameters to be used.
        """
        bos_id = tf.cast(self.vocab_table.lookup(
            tf.constant(hparams.bos_token)), tf.int32)
        eos_id = tf.cast(self.vocab_table.lookup(
            tf.constant(hparams.eos_token)), tf.int32)
        ...
        with tf.variable_scope('decoder') as decoder_scope:
            ...
            if self.training:
                ...
                # Assistant
                assistant = tf.contrib.seq2seq.TrainingHelper(
            ...
            # Inference
                ...
                if beam_width > 0:
                    ...
                    # Assistant
                    assistant = tf.contrib.seq2seq.GreedyEmbeddingHelper(
    ...
    def _build_decoder_cell(self, hparams, encoder_outputs, encoder_state,
        ...
        Arguments:
            ...
            encoder_outputs: Encoder output.
            encoder_state: Current state of the encoder.
            source_sequence_length: Words in conversation sequence.
        """
        num_units = hparams.num_units
        num_layers = hparams.num_layers
        beam_width = hparams.beam_width
        ...
        cell = assistant.create_rnn_cell(
            num_units=num_units,
    ...
    def infer(self, sess):
        ...
        # Make sure output is of shape [batch_size, time]
        if self.time_major:
